# 1 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c"
...
# 1 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
...
# 2 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
...
# 3 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
...
# 4 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
...
Action()
{
    ...
    if (atoi(lr_eval_string("{HomePageCheck}")) > 0)
        lr_end_transaction("01_Open_HomePage", 0);
    else
        lr_end_transaction("01_Open_HomePage", 1);
    ...
    if (atoi(lr_eval_string("{FindFlightCheck}")) > 0)
        lr_end_transaction("02_Find_Flights", 0);
    else
        lr_end_transaction("02_Find_Flights", 1);
   ...
   web_submit_data("Choose_Flight",
    ...
    if (atoi(lr_eval_string("{PurchaseCheck}")) > 0)
        lr_end_transaction("04_Purchase_Ticket", 0);
    else
        lr_end_transaction("04_Purchase_Ticket", 1);
	
	return 0;
}
# 5 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
...
# 6 "c:\\users\\anil\\documents\\vugen\\scripts\\demoscripts\\\\combined_DemoScripts.c" 2
